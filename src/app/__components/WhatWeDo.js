...
export default function WhatWeDo() {
  return (
    <div className='h-[100vh] w-full bg-gray-500/5 flex items-center justify-center'>
        <div className="w-[98%] max-w-[850px] flex flex-col gap-4 items-start justify-center">
            <div className="text-[1.3rem] font-medium text-rose-600">WHAT WE DO</div>
