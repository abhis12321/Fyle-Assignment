  ...
  return (
    <div className='w-full h-[100vh] flex gap-10 items-center justify-center'>
      <div className="flex flex-col gap-8 max-w-[40%]">
        ...
        <button className="w-fit bg-red-700/90 hover:bg-red-600 text-white rounded py-3 px-8 text-[10px] font-semibold font-sans" onClick={e => setContact(true)}>CONTACT US</button>
        {
            contact && <ContactForm setContact={setContact} />
        }
      </div>
      <div className="">
